...
public class PanGame extends JPanel implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        try {
            ...
            //TEST
            //nBgX -= 10;
            g2d.drawImage(iPlat[nPlat[0]], nBgX+0, 0, null);
            g2d.drawImage(iPlat[nPlat[1]], nBgX+150, 0, null);
            g2d.drawImage(iPlat[nPlat[2]], nBgX+300, 0, null);
            g2d.drawImage(iPlat[nPlat[3]], nBgX+450, 0, null);
            //TEST
        } catch (Exception e) {
            e.printStackTrace();
        }
